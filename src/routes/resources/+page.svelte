...
<svelte:head>
	<title>Rob Morris's Resources</title>
</svelte:head>
...
<section class="bg-gray-900 text-white">
	<div class="mx-auto max-w-screen-xl px-4 py-32 lg:flex lg:items-center">
		<div class="mx-auto max-w-3xl text-center">
			<h1
				class="bg-gradient-to-br from-green-300 via-blue-500 to-purple-600 bg-clip-text text-3xl font-extrabold text-transparent sm:text-5xl p-5"
			>
				Resources.
			</h1>
		</div>
